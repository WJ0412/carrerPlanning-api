...
public class XueYe4Handler {
    private Configuration configuration = null;

    public XueYe4Handler() {
    ...
    public String createXueYe(HttpServletRequest request, Map<String, String> maps) {
        ...
        String fileName=maps.get("studentid")+"学业规划（四）.doc";
        ...
        try {
            t = configuration.getTemplate("xueye4.ftl");
            t.setEncoding("utf-8");
