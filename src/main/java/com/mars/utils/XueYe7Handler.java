...
public class XueYe7Handler {
    private Configuration configuration = null;

    public XueYe7Handler() {
    ...
    public String createXueYe(HttpServletRequest request, Map<String, String> maps) {
        ...
        String fileName=maps.get("studentid")+"学业规划（七）.doc";
        ...
        try {
            t = configuration.getTemplate("xueye7.ftl");
            t.setEncoding("utf-8");
