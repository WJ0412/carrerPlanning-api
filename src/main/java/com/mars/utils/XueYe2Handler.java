...
public class XueYe2Handler {
    private Configuration configuration = null;

    public XueYe2Handler() {
    ...
    public String createXueYe(HttpServletRequest request, Map<String, String> maps) {
        ...
        String fileName=maps.get("studentid")+"学业规划（二）.doc";
        ...
        try {
            t = configuration.getTemplate("xueye2.ftl");
            t.setEncoding("utf-8");
