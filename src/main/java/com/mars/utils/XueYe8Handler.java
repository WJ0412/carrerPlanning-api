...
public class XueYe8Handler {
    private Configuration configuration = null;

    public XueYe8Handler() {
    ...
    public String createXueYe(HttpServletRequest request, Map<String, String> maps) {
        ...
        String fileName=maps.get("studentid")+"学业规划（八）.doc";
        ...
        try {
            t = configuration.getTemplate("xueye8.ftl");
            t.setEncoding("utf-8");
