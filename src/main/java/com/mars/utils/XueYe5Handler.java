...
public class XueYe5Handler {
    private Configuration configuration = null;

    public XueYe5Handler() {
    ...
    public String createXueYe(HttpServletRequest request, Map<String, String> maps) {
        ...
        String fileName=maps.get("studentid")+"学业规划（五）.doc";
        ...
        try {
            t = configuration.getTemplate("xueye5.ftl");
            t.setEncoding("utf-8");
