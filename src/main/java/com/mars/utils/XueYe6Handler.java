...
public class XueYe6Handler {
    private Configuration configuration = null;

    public XueYe6Handler() {
    ...
    public String createXueYe(HttpServletRequest request, Map<String, String> maps) {
        ...
        String fileName=maps.get("studentid")+"学业规划（六）.doc";
        ...
        try {
            t = configuration.getTemplate("xueye6.ftl");
            t.setEncoding("utf-8");
